    ...
    <div className="mx-auto w-full max-w-[1440px] px-4 min-[1440px]:px-[60px]">
      <div className="grid grid-cols-1 gap-14 [place-items:center_stretch] min-[768px]:grid-cols-2 min-[768px]:gap-[88px]">
        <div className="order-1 flex flex-1 flex-col items-start justify-start min-[768px]:order-1">
          ...
          {description && (
            <div
              className="m-0 mb-8 [font-family:var(--font-jakarta),ui-sans-serif,system-ui,sans-serif] text-[20px] font-medium leading-[1.5] tracking-normal text-[#001122] max-[768px]:mb-0 [&_ul]:list-disc [&_ul]:pl-6 [&_li]:mb-1 [&_li]:last:mb-0"
          ...
          {buttonTitle && buttonLink && (
            <Link
              href={buttonLink}
              className="mt-6 inline-flex min-w-[232px] items-center justify-between gap-3 border border-[#00112233] bg-[#001122] px-6 py-3 text-sm font-medium text-white transition-colors duration-300 hover:bg-transparent hover:text-[#001122]"
            >
              {buttonTitle}
