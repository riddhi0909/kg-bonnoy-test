        ...
        <div className="relative max-[991px]:order-[-1] min-[992px]:shadow-[400px_0_0_400px_#faf5ef]">
          ...
          <div className="relative z-0 px-0 pt-[14px] pb-[81px] text-[18px] min-[992px]:pl-24  max-[991px]:px-4">
            {contentList.map((line, idx, arr) => (
              <p
                key={line}
                className={`[font-family:var(--font-jakarta),ui-sans-serif,system-ui,sans-serif] text-[18px] font-normal leading-[1.5] tracking-normal text-[#001122] ${idx !== arr.length - 1 ? "mb-[52px] border-b border-[#ddd4c6] pb-[52px]" : ""}`}
              >
                {line}
              </p>
            ))}
