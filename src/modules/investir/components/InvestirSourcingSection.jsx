...
export function InvestirSourcingSection({ imageSrc = "", imageAlt = "", title = "", subHeading = "", description = "", button }) {    
  return (
    <div
        ...
        <div className="mx-auto w-full max-w-[1440px] px-4 min-[1440px]:px-[60px] max-[768px]:pr-0 max-[768px]:pl-[64px]">
          <div className="ml-auto flex h-auto min-w-[428px] w-[25vw] flex-col gap-6 bg-[#000d29] p-[90px_60px] max-[768px]:w-full max-[768px]:min-w-0 max-[768px]:p-[32px_32px_64px] max-[479px]:min-w-auto">
            ...
            <Link
              ...
              className="group mt-0 flex min-h-10 min-w-[232px] w-max items-center justify-center gap-[15px] bg-[#f63] px-[15px] py-2 border border-[#f63] text-sm font-medium leading-[1.428] text-white transition-all duration-300 hover:bg-white hover:text-[#f63]"
            >
              {button.title}
              {button.url && (
