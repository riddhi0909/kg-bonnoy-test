...
export function InvestmentAccordionSection({ title, description, accordion, image, imageAlt }) {
  ...
  return (
    <div className="">
      <div className="mx-auto w-full max-w-[1440px] px-4 min-[1440px]:px-[60px]">
        <div className="">
          <h2 className="m-0 mb-5 text-center font-serif text-[36px] font-medium leading-[1.2] tracking-normal min-[768px]:mb-8 min-[768px]:text-[48px] max-[479px]:text-left min-[768px]:max-w-[50%] mx-auto">
            {title}
          </h2>
