...
export function InvestirHeroSection({
  title1,
  title2,
  heroImage,
}) {
  ...
  const widthProgress =
    ...
    if (isMobile) {
      boxWidthPercent = 90 + widthProgress * 10;
    } else {
      boxWidthPercent = 63 + widthProgress * 37;
    }
    ...
    >
      ...
      >
        ...
        >
          ...
          />
          <h1 className="relative z-[2] whitespace-pre-line text-center font-serif text-[40px] font-medium leading-[1.1] text-[#001122] min-[768px]:text-[52px] wrap-break-word">
            {title1}
            <br />
            {title2}
          </h1>
